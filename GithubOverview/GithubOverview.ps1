...
$repos = (gh repo list -L 10000 --json "description,id,isArchived,isFork,isPrivate,issues,latestRelease,licenseInfo,name,owner,parent,pullRequests,url,updatedAt") | ConvertFrom-Json
