...
(Get-Item (Join-Path $dir "1.txt")).LastWriteTimeUtc = [DateTime]::Parse("2026-08-25T11:30:00Z").ToUniversalTime()
Set-Content -Path (Join-Path $dir "2.txt") -Value "This is 2"
(Get-Item (Join-Path $dir "2.txt")).LastWriteTimeUtc = [DateTime]::Parse("2026-08-25T11:40:00Z").ToUniversalTime()
Set-Content -Path (Join-Path $dir "a\3.txt") -Value "This is 3"
(Get-Item (Join-Path $dir "a\3.txt")).LastWriteTimeUtc = [DateTime]::Parse("2026-08-25T11:50:00Z").ToUniversalTime()
Set-Content -Path (Join-Path $dir "b\4.txt") -Value "This is 4"
(Get-Item (Join-Path $dir "b\4.txt")).LastWriteTimeUtc = [DateTime]::Parse("2026-08-25T12:00:00Z").ToUniversalTime()
Set-Content -Path (Join-Path $dir "b\c\5.txt") -Value "This is 5"
(Get-Item (Join-Path $dir "b\c\5.txt")).LastWriteTimeUtc = [DateTime]::Parse("2026-08-25T12:10:00Z").ToUniversalTime()
